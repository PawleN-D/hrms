...
>
  ...
  />
  <path
    d="M11.6406 7.5385L11.2406 7.5385C10.7406 7.5385 10.4406 7.8385 10.4406 8.3385C10.4406 8.8385 10.7406 9.1385 11.2406 9.1385H11.6406C12.1406 9.1385 12.4406 8.8385 12.4406 8.3385C12.4406 7.8385 12.1406 7.5385 11.6406 7.5385Z"
    fill=""
  />
  <path
    d="M10.0006 0.664062C5.30285 0.664062 1.34375 4.62316 1.34375 9.32081C1.34375 11.6767 2.57497 13.8772 4.69973 15.2783C4.90915 15.4487 5.23804 15.4315 5.44746 15.2611C7.20435 13.8085 9.38145 12.8122 11.8113 12.8122C16.5091 12.8122 20.4688 8.85312 20.4688 4.15537C20.4688 1.85219 19.3036 0.664062 18.007 0.664062H10.0006V0.664062Z"
    fill=""
  />
</svg>
...
const RightHalf = () => {
  return (
    <div className="w-full sm:w-1/2 p-4">
      <div className="bg-gray-200 p-4 mb-4">
        <h2 className="text-lg font-bold mb-2">Section 2.1</h2>
        <p>Heading content</p>
      </div>

      <div className="bg-gray-200 p-4 mb-4">
        <h2 className="text-lg font-bold mb-2">Section 2.2</h2>
        <div className="bg-white">
          {/* Linear calendar component here */}
        </div>
      </div>

      <div className="bg-gray-200 p-4">
        <h2 className="text-lg font-bold mb-2">Section 2.3</h2>
        {/* Your table here */}
      </div>
    </div>
  );
